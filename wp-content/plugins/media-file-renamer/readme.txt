...
* Info: The plugin was deleted by mistake from the repo! Sorry about that, I did a mistake. It was promptly fixed by WP team. As always, if you like the plugin, please write a little review on https://wordpress.org/support/view/plugin-reviews/media-file-renamer, for my motivation :) Also don't hesitate to mention the features you would like to see added. Cheers :)
