...
*  Slider auto slide is not stoppable, but putting a huge number on "pause time" option will force visitors slide manually.
...
= How to install the PRO version of plugin slider? =

In order to install pro version of the slider plugin, simply follow these steps:
