...
$example_update_checker = new ThemeUpdateChecker(
	'Torres',                                            //Theme folder name, AKA "slug". 
	'http://www.fabthemes.com/versions/torres.json' //URL of the metadata file.
); 
...
function web2feel_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Footer middle', 'web2feel' ),
		'id'            => 'footer-2',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h1 class="widget-title">',
...
function web2feel_scripts() {
	...
	wp_enqueue_script( 'flexslider', get_template_directory_uri() . '/js/jquery.flexslider-min.js', array(), '20120206', true );
