...
<div class="container_12 inner-cover cf">	

	<h2 class="homeblog-title grid_4 "> Services </h2>
	<div class="clear"></div>
			<?php if ( ! dynamic_sidebar( 'Homepage widget' ) ) : ?>

			<?php endif; // end sidebar widget area ?>

	<div class="clear"></div>
	<h2 class="homeblog-title grid_4 "> From the blog </h2>
	<div class="clear"></div>
				...
				<div class="homepost grid_4">
		 		...
		 		<?php
					...
					$image = aq_resize( $img_url, 280, 150, true ); //resize & crop the image
				?>
