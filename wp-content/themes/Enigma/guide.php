...
<div id="welcome-panel" class="about-wrap">
	...
	<p class="about-text"> Enigma is a free premium WordPress theme. This is a WordPress 3+ ready theme with features like custom menu, Custom homepage with widgetized area, custom message and featured images, widgetized sidebar etc. Theme also comes with an option panel. The homepage of the theme has a customizable jQuery content slider. </p>
